    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1 order-2">
                ...
                <div class="contact-box-container">
                    <a href="https://www.instagram.com/misterflinck/" target="_blank"  class="contact-box text-decoration-none">
                        ...
                        <div class="content-container">
                            <p class="contact-type"><?php echo pll__('Instagram'); ?> &raquo;</p>
                        </div>
                    </a>
                </div>
                <div class="contact-box-container">
                    <a href="https://www.facebook.com/misterflinck" target="_blank" class="contact-box text-decoration-none">
                ...
                <div class="contact-box-container">
                    <a href="https://www.tiktok.com/@misterflinck" target="_blank" class="contact-box text-decoration-none">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M448 209.9a210.1 210.1 0 0 1 -122.8-39.3V349.4A162.6 162.6 0 1 1 185 188.3V278.2a74.6 74.6 0 1 0 52.2 71.2V0l88 0a121.2 121.2 0 0 0 1.9 22.2h0A122.2 122.2 0 0 0 381 102.4a121.4 121.4 0 0 0 67 20.1z"/></svg>
                        <div class="content-container">
                            <p class="contact-type"><?php echo pll__('TikTok'); ?> &raquo;</p>
                        </div>
                    </a>
                </div>
            </div>
